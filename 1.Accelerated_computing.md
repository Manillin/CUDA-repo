...
![thrust](img/sw_stack_nvidia.png)
...
![porting algo in GPU](img/porting_GPU.png) 
...
![zip transform iterator](img/zip_transoform_iterator.png)   
...
![heat equation](img/heat_equation.png) 
...
![sum rows](img/sum_rows_CUDA.png)     

...
![sim state i](img/simulation_i.png) 
...
![overlapping CPU&GPU](img/overlapping_CUB.png)
...
![overlapping CPU&GPU](img/overlapping_CUB2.png)
...
![cuda stream seq](img/cuda_stream_SQ.png)
...
![cuda stream](img/cuda_streams.png)
